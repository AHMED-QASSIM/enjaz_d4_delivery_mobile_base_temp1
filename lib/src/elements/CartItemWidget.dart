                  ...
                  children: <Widget>[
                    Expanded(
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Helper.getPrice(widget.cart.getProductPrice(), context, style: Theme.of(context).textTheme.headline)
                        ],
                      ),
                    ),
                    SizedBox(width: 8),
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        Text(widget.cart.quantity.toString(), style: Theme.of(context).textTheme.subtitle),
                        IconButton(
                          onPressed: () {
                            setState(() {
                              widget.decrement();
