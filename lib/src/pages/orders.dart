                              ...
                              return Theme(
                                ...
                                child: ExpansionTile(
                                  ...
                                  trailing: Column(
                                    ...
                                    children: <Widget>[
                                      Helper.getPrice(Helper.getTotalOrdersPrice(_order), context, style: Theme.of(context).textTheme.headline),
                                      Text(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Helper.getPrice(_order.deliveryFee, context, style: Theme.of(context).textTheme.subtitle)
                                            ],
                                          ),
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Helper.getPrice(Helper.getTaxOrder(_order), context, style: Theme.of(context).textTheme.subtitle)
                                            ],
                                          ),
                                          Row(
                                            children: <Widget>[
