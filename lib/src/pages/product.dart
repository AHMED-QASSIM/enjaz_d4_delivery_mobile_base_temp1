                                        ...
                                        children: <Widget>[
                                          ...
                                          _con.product.discountPrice > 0
                                              ? Helper.getPrice(_con.product.discountPrice, context,
                                                  style: Theme.of(context).textTheme.body2.merge(TextStyle(decoration: TextDecoration.lineThrough)))
                                              : SizedBox(height: 0),
                                        ],
                                      ),
                                    ),
                              ...
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text(_con.quantity.toString(), style: Theme.of(context).textTheme.subtitle),
                                    IconButton(
                                      onPressed: () {
