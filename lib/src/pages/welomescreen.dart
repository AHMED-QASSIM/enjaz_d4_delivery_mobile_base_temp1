...
import 'package:markets/src/models/welcomedata.dart';
...
class WalkthroughScreen2Build extends StatelessWidget {
  ...
  _onPressed() {
    Navigator.of(context).pushReplacementNamed('/mylogin');
  }
                      ...
                      children: itemList.map((Items item) {
                        return new Column(
                          ...
                          children: <Widget>[
                            ...
                            new Text(S.of(context).delivery,style: heading35Black,
                            ),
                            new Container(
                            ...
                            ButtonTheme(
                              ...
                              child: RaisedButton(
                                ...
                                elevation: 0.0,
                                color: primaryColor,
                                child: new Text(S.of(context).skip,
                                  style: headingWhite,
                                ),
