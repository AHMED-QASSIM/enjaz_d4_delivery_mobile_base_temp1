    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: Theme.of(context).textTheme.headline.merge(TextStyle(letterSpacing: 1.3)),
          ),
        ),
                      ...
                      children: <Widget>[
                        ...
                        Opacity(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(context).textTheme.headline.merge(TextStyle(fontWeight: FontWeight.w300)),
                          ),
                        ),
                      ],
                    ),
                          ...
                          children: <Widget>[
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(_con.subTotal, context, style: Theme.of(context).textTheme.subtitle)
                              ],
                            ),
                            SizedBox(height: 3),
                            _con.payment.method == 'Pay on Pickup'
                                ...
                                : Row(
                                    children: <Widget>[
                                      ...
                                      Helper.getPrice(_con.carts[0].product.market.deliveryFee, context, style: Theme.of(context).textTheme.subtitle)
                                    ],
                                  ),
                            SizedBox(height: 3),
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(_con.taxAmount, context, style: Theme.of(context).textTheme.subtitle)
                              ],
                            ),
                            Divider(height: 30),
                            Row(
                              children: <Widget>[
                                ...
                                Helper.getPrice(_con.total, context, style: Theme.of(context).textTheme.headline)
                              ],
                            ),
                            SizedBox(height: 20),
                            SizedBox(
